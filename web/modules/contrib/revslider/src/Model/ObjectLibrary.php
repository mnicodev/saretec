...
class ObjectLibrary extends RevSliderElementsBase
{
    ...
    public function _is_object($url)
    {
        ...
        $upload_dir = RevSliderFile::uploadDirInfo(); // Set upload folder
    ...
    public function load_objects()
    {
        ...
        $svgs = RevSliderFunctions::get_svg_sets_full();

        $obj['svg'] = $svgs;
        $online = RevSliderOptions::getOptions('rs-library', array());
        if (!empty($online)) {
            $obj['online'] = $online;
        }
    ...
    public function _does_exist($url)
    {
        ...
        if (RevSliderFile::fileExists($upload_directory . $url)) {
            $does_exist = true;
        }
    ...
    public function _get_object_thumb($object_handle, $type)
    {
        ...
        $download = (RevSliderFile::fileExists($file)) ? true : false;
...
//        }
    ...
    public function get_correct_size_url($image_path, $imgres, $library_size = array())
    {
        ...
        if (!is_array($imgres)) {
            ...
            $img_sizes = RevSliderFunctions::get_intermediate_image_sizes();
        ...
        if (is_array($imgres)) {
            ...
            if (!RevSliderFile::fileExists($image_path)) return $image_path;
    ...
    public function _get_object_data($object_handle)
    {
        ...
        if (RevSliderFile::fileExists($file)) {
    ...
    {
        RevSliderOptions::updateOption('rs_obj_favorites', $favourites);
    }
    ...
    public function write_markup()
    {
        ...
        <div id="dialog_addobj" class="dialog-addobj" title="<?php echo t("Add Object Layer") ?>"
             style="display:none">
                ...
                <div id="addobj-list-of-items">
                    <div id="addobj-dialog-header">
                        <div class="object_library_search_wrapper">
                            <input type="text" id="obj_library_search"
                                   placeholder="<?php echo t("Search for Objects...") ?>"/><span
                                    id="obj_library_search_trigger"><i class="eg-icon-search"></i></span>
                        </div>
                        <div id="object_library_type_list_new">
                            <span id="obj_lib_main_cat_filt_all" data-value="all"
                                  class="obj_library_cats_filter"><?php echo t("ALL") ?></span>
                            <span id="obj_lib_main_cat_filt_allimages" data-value="allimages"
                                  class="obj_library_cats_filter all_img_cat"><?php echo t("ALL IMAGES") ?></span>
                            <span id="obj_lib_main_cat_filt_svg" data-value="svg"
                                  class="obj_library_cats_filter svg_cat"><?php echo t("SVG") ?></span>
                            <span id="obj_lib_main_cat_filt_icon" data-value="icon"
                                  class="obj_library_cats_filter fonticon_cat"><?php echo t("ICON") ?></span>
                            <span id="obj_lib_main_cat_filt_image" data-value="image"
                                  class="obj_library_cats_filter png_cat"><?php echo t("PNG") ?></span>
                            <span id="obj_lib_main_cat_filt_bgimage" data-value="bgimage"
                                  class="obj_library_cats_filter jpg_cat"><?php echo t("JPG") ?></span>
                        </div>
                        <div id="up-lic-ob-lib">
                            <div id="licence_obect_library"><i
                                        class="fa-icon-copyright"></i><?php echo t("License Info") ?>
                            </div>
                            <div id="update_obect_library"><i
                                        class="eg-icon-arrows-ccw"></i><?php echo t("Update Object Library") ?>
                            </div>
                        </div>
                        <div id="object-tag-list" class="object-tag-list"><span id="obj_library_cats_favorite"
                                                                                class="obj_library_cats"
                                                                                data-tag="favorite" data-image="true"
                                                                                data-bgimages="true" data-svg="true"><i
                                        class="fa-icon-star-o"
                                        style="margin-right: 5px;"></i><?php echo t("Favorite") ?></span><span
                                    id="obj_library_cats_allico" class="obj_library_cats" data-tag="allicon"
                                    data-icon="true" data-bgimages="false" data-svg="false"><i class="fa-icon-folder-o"
                                                                                               style="margin-right: 5px;"></i><?php echo t("All Icons") ?></span><span
                                    id="obj_library_cats_allpng" class="obj_library_cats" data-tag="allpng"
                                    data-image="true" data-bgimages="false" data-svg="false">
                                <i class="fa-icon-folder-o"
                                   style="margin-right: 5px;"></i><?php echo t("All PNG") ?></span><span
                                    id="obj_library_cats_alljpg" class="obj_library_cats" data-tag="alljpg"
                                    data-image="false" data-bgimages="true" data-svg="false"><i class="fa-icon-folder-o"
                                                                                                style="margin-right: 5px;"></i><?php echo t("All JPG") ?></span><span
                                    id="obj_library_cats_allsvg" class="obj_library_cats" data-tag="allsvg"
                                    data-image="false" data-bgimages="false" data-svg="true"><i class="fa-icon-folder-o"
                                                                                                style="margin-right: 5px;"></i><?php echo t("All SVG") ?></span>
                        </div>
                    </div>
            ...
            <div id="bg-vs-layer-wrapper">
                <span id="add_objimage_as_layer"><?php echo t("As Layer") ?></span><span
                        class="addthisasbg" id="obj-layer-bg-switcher"></span><span
                        id="add_objimage_as_slidebg"><?php echo t("As Slide BG") ?></span>
            </div>
    ...
    public function write_scripts(){
        ...
        <script>
            ...
            var is_font_icons_created = false;
            function createFontIcons() {
                if(is_font_icons_created)
                    return;
                is_font_icons_created = true;
                jQuery('#waitaminute .waitaminute-message').append('<br>Loading Font Icons');
                var document_sheets = document.styleSheets ,sheets = false,
                    obj = {},
                    fi = 1;
                ...
                if(document_sheets)
                {
                    ...
                    jQuery.each(document_sheets,function (index1,sheet1) {
                        if(sheet1.href)
                        {
                            sheets[_local_index]=sheet1;
                            _local_index++;
                        }
                         if(sheet1.rules)
                         {
                             jQuery.each(sheet1.rules,function (index2,sheet2) {
                                 if(sheet2.href && sheet2.styleSheet)
                                 {
                                     sheets[_local_index]=sheet2.styleSheet;
                                     _local_index++;
                                 }
                             });
                         }
                ...
                if (sheets)
                    jQuery.each(sheets,function(index,sheet) {
                        var found = false,
                            markup = "";
                        if (sheet && sheet.href && sheet.href.indexOf("revslider/assets/public/fonts/")>=0) {
                            try{
                                if (sheet.cssRules)
                                    jQuery.each(sheet.cssRules, function(index,rule) {
                                        if (rule && rule !=="null" && rule.selectorText) {
    ...
    public function get_favorites(){
        return RevSliderOptions::getOptions('rs_obj_favorites', array());
    }
}