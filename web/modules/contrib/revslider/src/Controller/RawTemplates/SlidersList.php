    ...
    public function getTemplate(array $args)
    {
        ...
        <ul class="tp-list_sliders">
            ...
            if(!$no_sliders){
                ...
                foreach($arrSliders as $slider){
                    ...
                    try{
                        ...
                        $editLink = RevSliderFunctions::getViewUrl(RevSliderGlobals::VIEW_SLIDER,array('id'=>$id));

                        $editSlidesLink = RevSliderFunctions::getViewUrl(RevSliderGlobals::VIEW_SLIDE,array('id'=>$first_slide_id));
                    ...
                    <li class="tls-slide tls-stype-all tls-stype-<?php echo $slider_type; ?>" data-favorit="<?php echo ($is_favorite) ? 'a' : 'b'; ?>" data-id="<?php echo $id; ?>" data-name="<?php echo $title; ?>" data-type="<?php echo $slider_type; ?>">
                        ...
                        <div class="tls-hover-metas">
                            ...
                            <span class="button-primary rs-embed-slider" ><i class="eg-icon-plus"></i><?php echo t("Embed Slider") ?></span>
                            <?php if(!RevSliderFunctions::isRS_DEMO()){ ?>
                                <a class="button-primary  export_slider_overview" id="export_slider_<?php echo $id; ?>" href="javascript:void(0);" ><i class="revicon-export"></i><?php echo t("Export") ?></a>
                                <?php
                                $operations = new Operations();
                                $general_settings = $operations->getGeneralSettingsValues();

                                $show_dev_export = RevSliderFunctions::getVar($general_settings, 'show_dev_export', 'off');

                                if($show_dev_export == 'on'){
                                    ?>
                                    <a class="button-primary  export_slider_standalone" id="export_slider_standalone_<?php echo $id; ?>" href="javascript:void(0);" ><i class="revicon-export"></i><?php echo t("Export to HTML") ?></a>
                                    <?php
                                }
                                ?>
                            <?php } ?>
                            <a class="button-primary  button_delete_slider" id="button_delete_<?php echo $id; ?>" href='javascript:void(0)'><i class="revicon-trash"></i><?php echo t("Delete") ?></a>
                            <a class="button-primary  button_duplicate_slider" id="button_duplicate_<?php echo $id; ?>" href='javascript:void(0)'><i class="revicon-picture"></i><?php echo t("Duplicate") ?></a>
                            <div id="button_preview_<?php echo $id; ?>" class="button_slider_preview button-primary revgray"><i class="revicon-search-1"></i><?php echo t("Preview") ?></div>
                        </div>
			...
			<span class="tls-main-metas">
				...
				<span class="tls-title-wrapper">			
					<span class="tls-title"><?php echo t("New Slider") ?></span>					
				</span>
			</span>
                </a>
            </li>
            <?php if(!RevSliderFunctions::isAdminUser()){ }else{ ?>
                <li class="tls-slide tls-addnewslider">
				...
				<span class="tls-main-metas">
					...
					<span class="tls-title-wrapper">			
						<span class="tls-title"><?php echo t("Import Slider") ?></span>					
					</span>
				</span>
                    </a>
                </li>
