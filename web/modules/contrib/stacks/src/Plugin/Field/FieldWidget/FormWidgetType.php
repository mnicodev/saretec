...
class FormWidgetType extends WidgetBase {
  ...
  public function settingsForm(array $form, FormStateInterface $form_state) {
    ...
    $elements['bundles_required_pos_locked'] = [
      ...
      '#required' => FALSE,
      '#description' => t('The widgets that are required, where the position cannot be changed (displayed at the top).'),
    ];
    ...
    $elements['bundles_required_pos_optional'] = [
      ...
      '#required' => FALSE,
      '#description' => t('The widgets that are required, where the position can be changed.'),
    ];
  ...
  public static function getWidgetInstanceField($wrapper_id, $widget_instance_id, $link_options) {
    ...
    $element['data']['title'] = [
      [
        ...
        '#value' => 'Wdiget instance ' . $widget_instance_id . ' missing',
      ],
      [
        '#type' => 'html_tag',
        '#tag' => 'h2',
    ...
    // Use the information from the widget form the widget row element
    $element['data']['title'][0]['#value'] = WidgetData::getWidgetType($widget_instance);
    $element['data']['title'][1]['#value'] = $widget_instance->getTitle();
