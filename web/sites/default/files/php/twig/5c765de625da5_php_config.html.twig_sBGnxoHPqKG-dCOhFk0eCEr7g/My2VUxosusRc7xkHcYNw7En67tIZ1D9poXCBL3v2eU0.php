...
";
    ...
    public function block_toolbar($context, array $blocks = [])
    {
        ...
        // line 4
        echo "    <a href=\"";
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->getUrl("webprofiler.dashboard", ["profile" => ($context["token"] ?? null)], ["fragment" => "php_config"]), "html", null, true));
        echo "\"
       title=\"";
        // line 5
    ...
    ";
        ...
        echo "\">";
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(($context["collector"] ?? null), "phpversion", []), "html", null, true));
        echo "</a></span>
        </div>
        ...
        // line 18
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar((($this->getAttribute(($context["collector"] ?? null), "hasxdebug", [])) ? ("green") : ("red"))));
        echo "\">xdebug</span>
            <span class=\"sf-toolbar-status sf-toolbar-status-";
        // line 19
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar((($this->getAttribute(($context["collector"] ?? null), "hasaccelerator", [])) ? ("green") : ("red"))));
        echo "\">accel</span>
        </div>
        ...
        echo "</b>
            <span>";
        // line 23
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(($context["collector"] ?? null), "sapiName", []), "html", null, true));
        echo "</span>
        </div>
        <div class=\"sf-toolbar-info-piece\">
            <b>Token</b>
...
";
    ...
    {
        return new Twig_Source("", "@webprofiler/Collector/php_config.html.twig", "/var/www/html/saretec/web/modules/contrib/devel/webprofiler/templates/Collector/php_config.html.twig");
    }
}
