...
";
    ...
    public function block_toolbar($context, array $blocks = [])
    {
        ...
        // line 3
        echo "    <a href=\"";
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->getUrl("webprofiler.dashboard", ["profile" => ($context["token"] ?? null)], ["fragment" => "performance_timing"]), "html", null, true));
        echo "\"
       title=\"";
        // line 4
    ...
    <script>
        ...
        Webprofiler.ajax('";
        // line 47
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->getUrl("webprofiler.frontend.save", ["profile" => ($context["token"] ?? null)]), "html", null, true));
...
";
    ...
    {
        return new Twig_Source("", "@webprofiler/Collector/performance_timing.html.twig", "/var/www/html/saretec/web/modules/contrib/devel/webprofiler/templates/Collector/performance_timing.html.twig");
    }
}
